...
if [ -f "$SSH_PUB_KEY_PATH" ]; then
    ...
    echo "2. Go to: https://console.runpod.io/user/settings${NC}"
    echo "3. Scroll down to the 'SSH Public Keys' field"
    echo "4. Paste the public key and save your settings"
    echo "5. Go to your docker-compose.yml and copy public key into RUNPOD_SSH_PUBLIC_KEY"
    echo "6. Find your SSH key locally at ./keys/${NC} and add the path to docker-compose.yml @RUNPOD_SSH_PRIVATE_KEY_PATH"
    echo ""
    ...
    echo "1. Once you've added the needed values to Runpod related docker-compose environment values"
    echo "You can continue to intialize understudy"
    echo ""
